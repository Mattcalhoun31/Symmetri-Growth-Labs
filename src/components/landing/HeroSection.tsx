        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <div className="space-y-6 animate-on-scroll visible">
            ...
            <h1 className="font-bold leading-tight tracking-tight">
              <span className="block text-white text-[40px] sm:text-[45px] lg:text-[50px]">Your AI Tools Aren't Broken.</span>
              <span className="block text-ember-gradient text-[40px] sm:text-[45px] lg:text-[50px] mt-[5px] mb-[5px]">Your GTM System Is.</span>
            </h1>
            
            <p className="text-lg sm:text-xl text-white/90 max-w-xl leading-relaxed">
              We transform underperforming sales operations into autonomous revenue engines — through integrated data infrastructure, AI-powered outreach, and elite human performance coaching.
            </p>
            ...
            <p className="text-sm text-white/70 max-w-lg pt-2">
              Built for B2B teams selling into complex buying committees across SaaS, Tech, and Enterprise services.
            </p>
          </div>
