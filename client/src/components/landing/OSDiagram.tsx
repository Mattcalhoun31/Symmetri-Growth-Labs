...
const modules: Module[] = [
  {
    ...
    title: "90% Clean Data",
    icon: Database,
    microLabel: "Industry avg: 30%",
    position: { angle: 0, distance: 140 },
    color: "#ff7a1a",
  },
  {
    id: "agents",
    title: "AI That Sells 24/7",
    icon: Bot,
    microLabel: "Research, write, engage",
    position: { angle: 90, distance: 140 },
    color: "#ffaa33",
  },
  {
    id: "stealth",
    title: "Spam-Proof Outreach",
    icon: Phone,
    microLabel: "S.T.E.A.L.T.H.™ Method",
  ...
  },
  {
    ...
    icon: Target,
    microLabel: "Strategy + Optimization",
